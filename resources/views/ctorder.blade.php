        ...
        @endphp
         @foreach($ctdh as $ct)
              ...
              @endphp
               ...
               <tr>
                   <th class="table-cart-product"><img src="image/{{$ct->product->product_img}}"></th>
                   <th class="table-cart-product"><a href="">{{$ct->product->title}}</a></th>
                   <th class="table-cart-product">{{$ct->soluong}}</th>
                   <th class="table-cart-product"><p class="number">{{$ct->product->price}}</p></th>
